...
const { MeetupView } = require(global.getSolutionPath('MeetupView'));
const { UiContainer } = require(global.getSolutionPath('UiContainer'));
const { UiAlert } = require(global.getSolutionPath('UiAlert'));
